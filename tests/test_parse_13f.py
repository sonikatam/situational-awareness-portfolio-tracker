...
def test_unannotated_modern_values_are_dollars():
    xml = '''<informationTable><infoTable><nameOfIssuer>A</nameOfIssuer><titleOfClass>COM</titleOfClass><cusip>111111111</cusip><value>13676657577</value><shrsOrPrnAmt><sshPrnamt>5</sshPrnamt><sshPrnamtType>SH</sshPrnamtType></shrsOrPrnAmt></infoTable></informationTable>'''
    assert parse_13f_xml(xml)[0]["value_usd"] == "13676657577"
